...
let db = new sqlite3.Database(DBSOURCE, (err) => {
    if (err) {
        ...
        db.run(`CREATE TABLE IF NOT EXISTS TEAM(LEAGUE CHAR, TNAME CHAR, DESCRIPTION CHAR, YEAR INT, MONTH INT, DAY INT,
                          PRIMARY KEY(LEAGUE, TNAME), FOREIGN KEY(LEAGUE) REFERENCES ESPORT(LEAGUE));`);
